var hen,henImage,b1,b2,b3,b4,ctrl,back1,back2,back3,back4,back5,back6
var GS1=1,GS2=2,GS3=3
var gameState=1
var lol,atk,box1,box2,box3,box4,box5
...
function preload(){
  ...
  bgImage6 = loadImage("img/bg6.png")
  ...
  bob_img = loadAnimation("img/v1.png","img/v2.png")
  vcSound = loadSound("img/victory.mp3")
  egg_i = loadImage("img/egg.png")
  end_i = loadImage("img/Untitled.png")
}
...
//**********************************//
  wall7=createSprite(300,5,800,5)
  wall7.visible=false
...
//backgrounds
  ...
  back6=createSprite(300,300)
  back6.addImage("back6",bgImage6)
  back6.scale=0.6
  back6.visible=false
  //----------------------------------------//
  //countroller
...
//---------------------------------------------//
bob1=createSprite(1000,86,50,50)
bob1.addAnimation("bob1",bob_img)
bob1.scale=0.6

egg = createSprite(1000,1000,50,50)
egg.addImage("egg",egg_i)
egg.scale=0.1

//-------------------------------------------------//
end = createSprite(300,950)
end.addImage("end",end_i)
end.scale=0.6
...
if(hen.isTouching(peice4)){
  text("PRESS SPACE TO ATTACK OR TOUCH ATTACK BUTTON",250,77)
  peice4.destroy()
